...
subm_slop(const submarine_t * sub) {
  if (sub->x == sub->origin_x) return -((double)1.79769313486231570815e+308L);
...
sort_submarines(submarine_t * submarines, int submarines_len,
  ...
  for (; i < submarines_len; i++) {
    ...
    double prev_d = prev == -((double)1.79769313486231570815e+308L) ? -9.99 : prev;
...
same_submarines_len(submarine_t * submarines, int submarines_len) {
  ...
  for (; i < submarines_len; i++) {
    ...
    double prev_d = prev == -((double)1.79769313486231570815e+308L) ? -9.99 : prev;
    double next_d = next == -((double)1.79769313486231570815e+308L) ? -9.99 : next;
